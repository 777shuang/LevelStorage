...
public class EnergyRayFX extends EntityFX {
    ...
    public EnergyRayFX(World par1World, double px, double py, double pz, double tx, double ty, double tz, float red,
    ...
    public void onUpdate() {
        ...
        List entities = this.worldObj.getEntitiesWithinAABB(
            EntityMob.class,
            AxisAlignedBB.getBoundingBox(tX - 4, tY - 4, tZ - 4, tX + 4, tY + 4, tZ + 4));
    ...
    public void renderParticle(Tessellator tessellator, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        float rot = (float) (this.worldObj.provider.getWorldTime() % (360 / this.rotationspeed) * this.rotationspeed)
