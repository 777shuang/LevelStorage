...
public class ModAchievements {
    ...
    public void init() {
         ...
         */
        craftHelmet = new Achievement(736781, "tesla", 3, -4, new ItemStack(LSBlockItemList.itemArmorTeslaHelmet), null)
            .registerAchievement();
        LanguageRegistry.instance()
            .addStringLocalization("achievement.tesla", "Rays, rays everywhere!");
        LanguageRegistry.instance()
            .addStringLocalization("achievement.tesla.desc", "Craft a tesla helmet.");
