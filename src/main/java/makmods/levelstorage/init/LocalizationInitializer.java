...
public class LocalizationInitializer {
    ...
    public static final String LOCALIZATION_PATH_PREFIX = "/assets/" + Reference.MOD_ID.toLowerCase() + "/lang/";
    ...
    public void init() {
        for (String locale : localizationList) {
            ...
            LanguageRegistry.instance()
                .loadLocalization(LOCALIZATION_PATH_PREFIX + locale + ".lang", locale, false);
        }
    }
}
