...
public class BlockFluidIV extends BlockFluidClassic {
    ...
    public BlockFluidIV() {
        super(
            LevelStorage.configuration.getBlock("fluidIV", ModUniversalInitializer.instance.getNextBlockID())
                .getInt(),
    ...
    public void registerIcons(IconRegister iconRegister) {
        Icon still = iconRegister.registerIcon(ClientProxy.FLUID_IV_STILL_TEXTURE);
        Icon flowing = iconRegister.registerIcon(ClientProxy.FLUID_IV_FLOWING_TEXTURE);
