...
public class OreDictHelper {
    ...
    static {
        if (!oreExists("oreCoal")) {
            if (LevelStorage.configuration.get(Configuration.CATEGORY_GENERAL, "addCoalOreToOreDict", true)
                .getBoolean(true)) OreDictionary.registerOre("oreCoal", Block.oreCoal);
        }
        ...
        if (LevelStorage.configuration.get(Configuration.CATEGORY_GENERAL, "addRedstoneOreToOreDict", true)
            .getBoolean(true)) {
