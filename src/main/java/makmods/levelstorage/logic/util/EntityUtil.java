...
public class EntityUtil {
    ...
    public static Entity getTarget(World world, EntityPlayer entityplayer, double range) {
        Entity pointedEntity = null;
        double d = range;
        Vec3 vec3d = Vec3.fakePool
            .getVecFromPool(entityplayer.posX, entityplayer.posY + entityplayer.getEyeHeight(), entityplayer.posZ);
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            if ((entity.canBeCollidedWith()) && (world.rayTraceBlocks_do_do(
                world.getWorldVec3Pool()
                    .getVecFromPool(
                        ...
                        entityplayer.posZ),
                world.getWorldVec3Pool()
                    .getVecFromPool(entity.posX, entity.posY + entity.getEyeHeight(), entity.posZ),
                false,
                true) == null)) {
