...
public class RenderHelper {
    ...
    public static void bindTexture(ResourceLocation resLoc) {
        FMLClientHandler.instance()
            .getClient().renderEngine.bindTexture(resLoc);
    }
    ...
    public static void renderTank(FluidTank tank, int xOffset, int yOffset, int x, int y) {
        xOffset -= 1;
        yOffset -= 1;
        ...
        if (tank.getFluidAmount() > 0) {
            ...
            if (fluidIcon != null) {
                ...
                RenderHelper.drawFluidWise(
                    fluidIcon,
                    xOffset + x + 1,
                    yOffset + y + 60 + 1 - liquidHeight,
                    16.0D,
                    liquidHeight,
                    zLevel);
            }
    ...
    public static void drawFluidWise(Icon icon, double x, double y, double width, double height, double z) {
    ...
    public static void renderIcon(Icon icon, double xStart, double yStart, double xEnd, double yEnd, double z, float nx,
        float ny, float nz) {
        if (icon == null) {
