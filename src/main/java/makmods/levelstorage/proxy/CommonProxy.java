...
public class CommonProxy {
    ...
    public void init() {
        NetworkRegistry.instance()
            .registerGuiHandler(LevelStorage.instance, new LSGUIHandler());
        ...
        biomeAntimatterField = new BiomeAntimatterField(
            LevelStorage.configuration.get("dimension", "biomeAntimatterFieldId", 40)
                .getInt());
        ...
        TickRegistry.registerTickHandler(new AntimatterUniverseRayHandler(), Side.SERVER);
    ...
    public void messagePlayer(EntityPlayer player, String message, Object[] args) {
        if ((player instanceof EntityPlayerMP)) {
            ChatMessageComponent msg = ChatMessageComponent.createFromText(message);
