...
public class SimpleRecipeAdder {
    ...
    public static void add3by3(ItemStack output, ItemStack input) {
        ...
        Recipes.advRecipes.addRecipe(output.copy(), "ccc", "ccc", "ccc", Character.valueOf('c'), ci);
    }
    ...
    public static void addChromeRecipes() {
        FurnaceRecipes.smelting()
            .addSmelting(
                ...
                SimpleItemShortcut.INGOT_CHROME.getItemStack()
                    .copy(),
                10.0F);
        add3by3(SimpleItemShortcut.DUST_CHROME.getItemStack(), SimpleItemShortcut.DUST_TINY_CHROME.getItemStack());
        ...
        FurnaceRecipes.smelting()
            .addSmelting(
                ...
                10.0F);
        // 3 outputs
        ItemStack oreWashingOutput1 = SimpleItemShortcut.PURIFIED_CHROME_ORE.getItemStack()
            .copy();
        ItemStack oreWashingOutput2 = SimpleItemShortcut.DUST_TINY_CHROME.getItemStack()
            .copy();
        oreWashingOutput2.stackSize = 2;
        ItemStack oreWashingOutput3 = Items.getItem("stoneDust")
            .copy();
        Recipes.oreWashing.addRecipe(
            new RecipeInputItemStack(SimpleItemShortcut.CRUSHED_CHROME_ORE.getItemStack()),
            null,
            oreWashingOutput1,
            oreWashingOutput2,
            oreWashingOutput3);
        // 3 outputs
        ItemStack centrifugeOutput1 = SimpleItemShortcut.DUST_CHROME.getItemStack()
            .copy();
        ItemStack centrifugeOutput2 = SimpleItemShortcut.DUST_TINY_OSMIUM.getItemStack();
        centrifugeOutput2.stackSize = 1;
        ItemStack centrifugeOutput3 = SimpleItemShortcut.TINY_IRIDIUM_DUST.getItemStack()
            .copy();
        Recipes.centrifuge.addRecipe(
            new RecipeInputItemStack(SimpleItemShortcut.PURIFIED_CHROME_ORE.getItemStack()),
            null,
            centrifugeOutput1,
            centrifugeOutput2,
            centrifugeOutput3);
        ...
        Recipes.compressor.addRecipe(
            new RecipeInputItemStack(irBit),
            null,
        ...
        Recipes.metalformerRolling.addRecipe(
            new RecipeInputItemStack(
                SimpleItemShortcut.INGOT_CHROME.getItemStack()
                    .copy()),
            null,
            SimpleItemShortcut.PLATE_CHROME.getItemStack()
                .copy());
    ...
    public static void addRecipesAfterMUIFinished() {
        ItemStack crushedChromiteOre = SimpleItemShortcut.CRUSHED_CHROME_ORE.getItemStack()
            .copy();
        crushedChromiteOre.stackSize = 2;
        Recipes.macerator.addRecipe(
            new RecipeInputItemStack(new ItemStack(LSBlockItemList.blockChromiteOre)),
            null,
            crushedChromiteOre);
        addChromeRecipes();
        ItemStack outp = new ItemStack(
            SimpleItems.instance.itemID,
            1,
        ...
        Recipes.advRecipes.addShapelessRecipe(
            ...
            new ItemStack(LSBlockItemList.blockMassMelter));
    }
    ...
    public static void addSimpleCraftingRecipes() {
        ...
        rec1.stackSize = 4;
        Recipes.compressor.addRecipe(
            new RecipeInputOreDict("itemOsmiridiumAlloy"),
            null,
            SimpleItemShortcut.OSMIRIDIUM_PLATE.getItemStack());
        // 4 tiny osmium dusts -> 1 dust
        GameRegistry.addRecipe(
            SimpleItemShortcut.DUST_OSMIUM.getItemStack(),
            "SS",
            "SS",
            Character.valueOf('S'),
        ...
        FurnaceRecipes.smelting()
            .addSmelting(osmDust.itemID, osmDust.getItemDamage(), osmIngot, 20.0F);

        // Osmium Ingots + Iridium Ingots = Osmiridium Alloy
        Recipes.advRecipes.addRecipe(
            SimpleItemShortcut.OSMIRIDIUM_ALLOY.getItemStack(),
            "OOO",
            "III",
            Character.valueOf('O'),
            "ingotOsmium",
        ...
        if (LevelStorage.configuration.get(Configuration.CATEGORY_GENERAL, "addIridiumOreToIngotCompressorRecipe", true)
            .getBoolean(true)) {
            try {
                Recipes.compressor.addRecipe(
                    new RecipeInputItemStack(Items.getItem("iridiumOre")),
                    null,
                    SimpleItemShortcut.INGOT_IRIDIUM.getItemStack());
            } catch (Throwable t) {
        ...
        Recipes.advRecipes.addRecipe(
            OreDictionary.getOres("itemAntimatterTinyPile")
                .get(0)
                .copy(),
            "ppp",
            "ppp",
        ...
        Recipes.advRecipes.addRecipe(
            OreDictionary.getOres("itemAntimatterGlob")
                .get(0)
                .copy(),
            "ppp",
            "ppp",
        ...
        Recipes.advRecipes.addRecipe(
            ...
            SimpleItemShortcut.ANTIMATTER_GLOB.getItemStack(),
            Character.valueOf('n'),
            new ItemStack(Item.netherStar).copy());
        Recipes.advRecipes.addShapelessRecipe(
            SimpleItemShortcut.JETPACK_ACCELERATOR.getItemStack(),
            Items.getItem("overclockerUpgrade"),
            IC2Items.CARBON_PLATE.copy(),
            IC2Items.CARBON_PLATE.copy(),
