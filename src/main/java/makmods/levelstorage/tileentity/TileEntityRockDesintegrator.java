...
public class TileEntityRockDesintegrator extends TileEntityInventorySink implements ISidedInventory, ITEHasGUI {
    ...
    public TileEntityRockDesintegrator() {
        ...
        for (int i = 0; i < this.getSizeInventory(); i++) slots[i] = new LogicSlot(this, i);
    }
