...
public class TileEntitySuperconductorCable extends TileEntity implements IEnergyConductor {
    ...
    public void onNeighborBlockChange() {
        ...
        for (ForgeDirection direction : ForgeDirection.VALID_DIRECTIONS) {
            ...
            if ((((neighbor instanceof IEnergyAcceptor))
                && (((IEnergyAcceptor) neighbor).acceptsEnergyFrom(this, direction.getOpposite())))
                || (((neighbor instanceof IEnergyEmitter))
                    && (((IEnergyEmitter) neighbor).emitsEnergyTo(this, direction.getOpposite())))) {
                newConnectivity = (byte) (newConnectivity | mask);

                if (((neighbor instanceof TileEntitySuperconductorCable))
                    && (((TileEntitySuperconductorCable) neighbor).getCableThickness() < getCableThickness())) {
