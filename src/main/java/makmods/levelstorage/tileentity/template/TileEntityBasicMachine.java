...
public abstract class TileEntityBasicMachine extends TileEntityInventorySink {
    ...
    public TileEntityBasicMachine(int inventorySize, int capacity, boolean useSlotMappings) {
        super(inventorySize);
    ...
    public boolean isItemValidForSlot(int i, ItemStack itemstack) {
        return useSlotMappings ? itemstack.itemID == slotMapping.get(i).itemID : true;
    }
