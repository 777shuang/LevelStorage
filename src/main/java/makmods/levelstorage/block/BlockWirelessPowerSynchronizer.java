...
public class BlockWirelessPowerSynchronizer extends BlockContainer implements IHasRecipe {
    ...
    public Icon getIcon(int side, int par2) {
        ...
        if (orientation == ForgeDirection.DOWN) return this.down;
        if (orientation == ForgeDirection.UP) return this.up;
        if (orientation == ForgeDirection.NORTH || orientation == ForgeDirection.WEST
            || orientation == ForgeDirection.SOUTH
            || orientation == ForgeDirection.EAST) return this.side;
        return null;
    }
    ...
    public void registerIcons(IconRegister iconRegister) {
        this.side = iconRegister.registerIcon(ClientProxy.WIRELESS_POWER_SYNC_TEXTURE + "Side");
        this.up = iconRegister.registerIcon(ClientProxy.WIRELESS_POWER_SYNC_TEXTURE + "Up");
        this.down = iconRegister.registerIcon(ClientProxy.WIRELESS_POWER_SYNC_TEXTURE + "Down");
    }
