...
public class BlockAntimatterStone extends Block {
    ...
    public int dropID = OreDictionary.getOres("itemAntimatterMolecule")
        .get(0).itemID;
    public int dropMeta = OreDictionary.getOres("itemAntimatterMolecule")
        .get(0)
        .getItemDamage();
    ...
    public void registerIcons(IconRegister iconRegister) {
        this.blockIcon = iconRegister.registerIcon(ClientProxy.ANTIMATTER_STONE_TEXTURE);
    }
