...
public class ItemAntimatterCrystal extends Item implements IElectricItem, IHasRecipe {
    ...
    public void registerIcons(IconRegister par1IconRegister) {
        this.itemIcon = par1IconRegister.registerIcon(ClientProxy.ANTIMATTER_CRYSTAL_TEXTURE);
    }
