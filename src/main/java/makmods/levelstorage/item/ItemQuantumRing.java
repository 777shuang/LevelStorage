...
public class ItemQuantumRing extends Item implements IElectricItem, IHasRecipe {
    ...
    public static ItemStack getRing(EntityPlayer ep) {
        ...
        for (ItemStack stack : inventory.mainInventory) {
            if (stack != null) if (stack.getItem() instanceof ItemQuantumRing) return stack;
        }
        return null;
    }
    ...
    public void registerIcons(IconRegister par1IconRegister) {
        this.itemIcon = par1IconRegister.registerIcon(ClientProxy.QUANTUM_RING_TEXTURE);
    }

    @Override
    public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
        par3List.add("\247b" + StatCollector.translateToLocal("tooltip.quantumring"));
    }
    ...
    public boolean chargeItem(ItemStack stack, ItemStack ring) {
        ...
        if (!ElectricItem.manager.canUse(ring, item.getTransferLimit(stack))) return false;
        int chargeSt = ElectricItem.manager.charge(stack, item.getTransferLimit(stack), 4, false, false);
    ...
    public void addCraftingRecipe() {
        Recipes.advRecipes.addRecipe(
            ...
            Character.valueOf('b'),
            new ItemStack(LSBlockItemList.itemLevitationBoots),
            Character.valueOf('l'),
            new ItemStack(LSBlockItemList.itemSupersonicLeggings));
