...
public class ItemFrequencyCard extends Item implements IHasRecipe {
    ...
    public void addCraftingRecipe() {
        ...
        Recipes.advRecipes
            .addShapelessRecipe(new ItemStack(LSBlockItemList.itemFreqCard), frequencyTr, new ItemStack(Item.paper));
        // To get rid of card data
        Recipes.advRecipes.addShapelessRecipe(
            new ItemStack(LSBlockItemList.itemFreqCard),
            new ItemStack(LSBlockItemList.itemFreqCard));
    }
    ...
    public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
        ...
        if (par1ItemStack.getTagCompound()
            .hasKey(BlockLocation.BLOCK_LOCATION_NBT)) {
            boolean isValid = isValid(par1ItemStack);
            BlockLocation location = BlockLocation.readFromNBT(par1ItemStack.getTagCompound());
            par3List.add(StatCollector.translateToLocal("tooltip.freqCard.location") + " " + location);
            par3List.add(
                StatCollector.translateToLocal("tooltip.freqCard.isValid") + " "
            ...
            if (par1ItemStack != null) {
                if (par3EntityPlayer.isSneaking()) {
                    ...
                    if (!isValid(par1ItemStack)) {
                        par1ItemStack = new ItemStack(LSBlockItemList.itemFreqCard);
                        NBTHelper.checkNBT(par1ItemStack);
                    }
                }
            }
    ...
    public void registerIcons(IconRegister par1IconRegister) {
        this.itemIcon = par1IconRegister.registerIcon(ClientProxy.FREQUENCY_CARD_TEXTURE);
    }
}
