...
public class ItemSuperconductor extends Item implements IHasRecipe {
    ...
    public ItemSuperconductor(int id) {
        ...
        Property pEnable = LevelStorage.configuration
            .get(Configuration.CATEGORY_GENERAL, "superConductorOreDictCompatible", true);
        ...
        if (pEnable.getBoolean(true)) OreDictionary.registerOre("itemSuperconductor", this);
    }

    public void addCraftingRecipe() {
        Property pOutput = LevelStorage.configuration
            .get(Configuration.CATEGORY_GENERAL, "superConductorRecipeOutput", 6);
        pOutput.comment = "Determines how much superconductors you get from one recipe";

        Recipes.advRecipes.addRecipe(
            new ItemStack(LSBlockItemList.itemSuperconductor, pOutput.getInt(6)),
            "ccc",
            "iai",
            "ccc",
            Character.valueOf('c'),
    ...
    public void registerIcons(IconRegister par1IconRegister) {
        this.itemIcon = par1IconRegister.registerIcon(ClientProxy.ITEM_SUPERCONDUCTOR_TEXTURE);
    }
}
