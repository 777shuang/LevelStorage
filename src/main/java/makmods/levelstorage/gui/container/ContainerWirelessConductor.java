...
public class ContainerWirelessConductor extends Container {
    ...
    public ContainerWirelessConductor(InventoryPlayer inventoryPlayer, TileEntityWirelessConductor te) {
        this.tileEntity = te;
        this.addSlotToContainer(new SlotFrequencyCard(this.tileEntity, 0, 80, 35));
    ...
    public ItemStack transferStackInSlot(EntityPlayer entityPlayer, int slotIndex) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if (slotIndex < 1) {
                ...
                if (!SlotFrequencyCard.checkItemValidity(slotItemStack)) return null;
                // End of warning
