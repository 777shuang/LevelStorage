...
public class ContainerIVGenerator extends Container {
    ...
    public ContainerIVGenerator(InventoryPlayer inventoryPlayer, TileEntityIVGenerator te) {
        this.tileEntity = te;
    ...
    public void detectAndSendChanges() {
        ...
        for (int i = 0; i < this.crafters.size(); i++) {
            ...
            icrafting.sendProgressBarUpdate(this, 4, this.tileEntity.latestSpeed);
    ...
    public ItemStack transferStackInSlot(EntityPlayer entityPlayer, int slotIndex) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if (slotIndex < 1) {
                if (!this.mergeItemStack(slotItemStack, 1, this.inventorySlots.size(), false)) return null;
            } else {
                if (!tileEntity.isItemValidForSlot(0, slotItemStack)) return null;
                // End of warning
                if (!this.mergeItemStack(slotItemStack, 0, 1, false)) return null;
            }
