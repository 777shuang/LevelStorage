...
public class ContainerParticleAccelerator extends ContainerWithPhantomSlots {
    ...
    public ContainerParticleAccelerator(InventoryPlayer inventoryPlayer, TileEntityParticleAccelerator te) {
        this.tileEntity = te;
        ...
        this.addSlotToContainer(new IVSampleSlot(tileEntity.phantomInventory, 0, 41, 34));
