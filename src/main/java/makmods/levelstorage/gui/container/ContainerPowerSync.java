...
public class ContainerPowerSync extends Container {
    ...
    public ContainerPowerSync(InventoryPlayer inventoryPlayer, TileEntityWirelessPowerSynchronizer te) {
        this.tileEntity = te;
    ...
    public void detectAndSendChanges() {
        ...
        for (int i = 0; i < this.crafters.size(); i++) {
            ...
            icrafting.sendProgressBarUpdate(this, 1, this.tileEntity.deviceType.ordinal());
        }
    }
