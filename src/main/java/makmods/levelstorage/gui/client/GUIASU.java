...
public class GUIASU extends GuiContainer {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        this.fontRenderer
            .drawString(this.name, (this.xSize - this.fontRenderer.getStringWidth(this.name)) / 2, 6, 4210752);
        ...
        int e = (int) Math.min(this.tileEntity.stored, TileEntityASU.EU_STORAGE);
        this.fontRenderer.drawString(" " + e, 110, 35, 4210752);
        this.fontRenderer.drawString("/" + TileEntityASU.EU_STORAGE, 110, 45, 4210752);
