...
public class GuiWirelessPowerSync extends GuiContainer {
    ...
    public GuiWirelessPowerSync(InventoryPlayer inventoryPlayer, TileEntityWirelessPowerSynchronizer te) {
    ...
    public void initGui() {
        ...
        this.freqTextBox = new GuiTextField(this.fontRenderer, xGuiPos + 50, yGuiPos + 15, 75, 15);
    ...
    protected void drawGuiContainerForegroundLayer(int param1, int param2) {
        ...
        this.fontRenderer.drawString(
            "Frequency: " + this.tileEntity.frequency
                + "; "
                + "Mode: "
                + (this.tileEntity.deviceType == SyncType.RECEIVER ? "receiver" : "sender"),
            8,
            55,
            4210752);
