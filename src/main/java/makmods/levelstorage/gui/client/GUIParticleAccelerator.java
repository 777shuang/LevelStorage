...
public class GUIParticleAccelerator extends GuiContainer {
    ...
    public GUIParticleAccelerator(InventoryPlayer inventory, TileEntityParticleAccelerator tile) {
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
        ...
        if (l > 0) drawTexturedModalRect(x + 82, y + 63 + 14 - l, 176, 152 + 14 - l, 14, l);
        int p = tileEntity.gaugeProgressScaled(53);
        if (p > 0) drawTexturedModalRect(x + 64, y + 36, 177, 114, p, 11);
    }
    ...
    public void initGui() {
        ...
        modeButton = new TexturedButton(
            1,
            xGuiPos + 7,
            yGuiPos + 59,
            SimpleItemShortcut.ANTMATTER_TINY_PILE.getItemStack(),
            true);
