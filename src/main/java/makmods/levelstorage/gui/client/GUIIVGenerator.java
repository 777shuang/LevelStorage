...
public class GUIIVGenerator extends GuiContainer {
    ...
    public GUIIVGenerator(InventoryPlayer inventoryPlayer, TileEntityIVGenerator tileEntity) {
    ...
    protected void drawGuiContainerForegroundLayer(int param1, int param2) {
        ...
        this.fontRenderer.drawString("Speed: " + this.tileEntity.latestSpeed + " IV/t", 30, 10, 4210752);
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
        ...
        int xOffset = x;
        int yOffset = y;
        RenderHelper.renderTank(tileEntity.getFluidTank(), xOffset, yOffset, 10, 10);
    }
}
