...
public class GUILavaFabricator extends GuiContainer {
    ...
    public GUILavaFabricator(InventoryPlayer inventoryPlayer, TileEntityLavaFabricator tileEntity) {
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
        ...
        if (this.tileEntity.getFluidTank()
            .getFluidAmount() > 0) {
            Icon fluidIcon = this.tileEntity.getFluidTank()
                .getFluid()
                .getFluid()
                .getIcon();
