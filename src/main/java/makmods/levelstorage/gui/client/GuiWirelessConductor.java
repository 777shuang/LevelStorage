...
public class GuiWirelessConductor extends GuiContainer {
    ...
    public GuiWirelessConductor(InventoryPlayer inventoryPlayer, TileEntityWirelessConductor tileEntity) {
    ...
    protected void drawGuiContainerForegroundLayer(int param1, int param2) {
        ...
        String mode = "Mode: "
            + (this.tileEntity.type == ConductorType.SOURCE ? "Energy transmitter" : "Energy receiver");
