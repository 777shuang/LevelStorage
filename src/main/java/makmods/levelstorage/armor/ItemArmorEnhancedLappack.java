...
public class ItemArmorEnhancedLappack extends ItemArmor
    ...
    public ItemArmorEnhancedLappack(int id) {
        super(id, EnumArmorMaterial.DIAMOND, LevelStorage.proxy.getArmorIndexFor(CommonProxy.ENH_LAPPACK_DUMMY), 1);
    ...
    public void addCraftingRecipe() {
        Property p = LevelStorage.configuration
            .get(Configuration.CATEGORY_GENERAL, "enableEnhancedLappackCraftingRecipe", true);
    ...
    public void registerIcons(IconRegister par1IconRegister) {
        this.itemIcon = par1IconRegister.registerIcon(ClientProxy.ENHANCED_LAPPACK_TEXTURE);
    }
