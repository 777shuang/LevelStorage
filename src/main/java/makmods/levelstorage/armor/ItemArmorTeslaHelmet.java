...
public class ItemArmorTeslaHelmet extends ItemArmor implements ISpecialArmor, IMetalArmor, IElectricItem, IHasRecipe {
    ...
    public ItemArmorTeslaHelmet(int id) {
        super(id, EnumArmorMaterial.DIAMOND, LevelStorage.proxy.getArmorIndexFor(CommonProxy.SUPERSONIC_DUMMY), 0);
    ...
    public static ItemStack playerGetArmor(EntityPlayer p) {
        ...
        for (ItemStack st : inv.armorInventory) {
            if (st != null && st.getItem() instanceof ItemArmorTeslaHelmet) found = st;
        }
    ...
    public void addCraftingRecipe() {
        Property p = LevelStorage.configuration
            .get(Configuration.CATEGORY_GENERAL, "enableTeslaHelmetCraftingRecipe", true);
    ...
    public void registerIcons(IconRegister par1IconRegister) {
        this.itemIcon = par1IconRegister.registerIcon(ClientProxy.TESLA_HELMET_TEXTURE);
    }
