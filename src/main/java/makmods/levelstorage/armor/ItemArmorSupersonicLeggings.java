...
public class ItemArmorSupersonicLeggings extends ItemArmor
    ...
    public ItemArmorSupersonicLeggings(int id) {
        super(id, EnumArmorMaterial.DIAMOND, LevelStorage.proxy.getArmorIndexFor(CommonProxy.SUPERSONIC_DUMMY), 2);
    ...
    public void addCraftingRecipe() {
        Property p = LevelStorage.configuration
            .get(Configuration.CATEGORY_GENERAL, "enableSupersonicLeggingsCraftingRecipe", true);
    ...
    public void registerIcons(IconRegister par1IconRegister) {
        this.itemIcon = par1IconRegister.registerIcon(ClientProxy.SUPERSONIC_LEGGINGS_TEXTURE);
    }
