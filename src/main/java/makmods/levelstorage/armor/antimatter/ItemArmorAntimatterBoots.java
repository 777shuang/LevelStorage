...
public class ItemArmorAntimatterBoots extends ItemArmorAntimatterBase implements IFlyArmor, IHasRecipe {
    ...
    public void addCraftingRecipe() {
        Recipes.advRecipes.addRecipe(
            new ItemStack(LSBlockItemList.itemArmorAntimatterBoots),
            "ici",
            "iai",
            "pep",
            'p',
