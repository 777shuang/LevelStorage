...
public class ItemArmorAntimatterHelmet extends ItemArmorAntimatterBase implements IHasRecipe {
    ...
    public void onArmorTickUpdate(World world, EntityPlayer player, ItemStack itemStack) {
        ...
        if (isSunVisible(player.worldObj, (int) player.posX, (int) player.posY + 1, (int) player.posZ)) {
            toCharge += 2048;
        }
    ...
    public void addCraftingRecipe() {
        Recipes.advRecipes.addRecipe(
            new ItemStack(LSBlockItemList.itemArmorAntimatterHelmet),
            "pcp",
            "pap",
            "pep",
            'p',
            ...
            'c',
            new ItemStack(LSBlockItemList.blockMulticoreSolarPanel));
    }
}
