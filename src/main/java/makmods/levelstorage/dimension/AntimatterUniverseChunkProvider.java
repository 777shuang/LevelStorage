...
public class AntimatterUniverseChunkProvider implements IChunkProvider {
    ...
    public AntimatterUniverseChunkProvider(World par1World, long par2) {
        ...
        for (int i = 0; i < otherContinents.length; i++) otherContinents[i] = new WorldGeneratorContinent();
                ...
                for (int y = 0; y < k; ++y) {
                    ...
                    if (id != 0) {
                        ...
                        if (chunk.getBlockStorageArray()[l] == null) {
                            chunk.getBlockStorageArray()[l] = new ExtendedBlockStorage(l << 4, !w.provider.hasNoSky);
                        }

                        chunk.getBlockStorageArray()[l].setExtBlockID(x, y & 15, z, id);
                    }
                }
            }
        }
    ...
    public void populate(IChunkProvider par1IChunkProvider, int par2, int par3) {
        ...
        new WorldGeneratorPillar().generate(random, par2, par3, this.worldObj, this, this);
        new WorldGeneratorAsteroids().generate(random, par2, par3, this.worldObj, this, this);
        new WorldGeneratorUUMFountain().generate(random, par2, par3, this.worldObj, this, this);
        new WorldGeneratorContinent().generate(random, par2, par3, this.worldObj, this, this);
    }
    ...
    private double[] initializeNoiseField(double[] par1ArrayOfDouble, int par2, int par3, int par4, int par5, int par6,
        ...
        double d0 = 684.412D;
        double d1 = 684.412D;
        this.noiseData4 = this.noiseGen4
            .generateNoiseOctaves(this.noiseData4, par2, par4, par5, par7, 1.121D, 1.121D, 0.5D);
        this.noiseData5 = this.noiseGen5
            .generateNoiseOctaves(this.noiseData5, par2, par4, par5, par7, 200.0D, 200.0D, 0.5D);
        d0 *= 2.0D;
