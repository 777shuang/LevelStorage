...
public class IVAPI {
    ...
    private static void lazyInit() {
        if (!wasInit) {
            try {
                api_ivRegistryClass = Class.forName("makmods.levelstorage.iv.IVRegistry");
                api_ivGetValue = api_ivRegistryClass.getMethod("getValue", Object.class);
                api_assignItemStack = api_ivRegistryClass
                    .getMethod("assignItemStack_dynamic", ItemStack.class, int.class);
                api_assignOreDict = api_ivRegistryClass.getMethod("assignOreDict_dynamic", String.class, int.class);
                api_instance = api_ivRegistryClass.getField("instance")
                    .get(null);
                NOT_FOUND = api_ivRegistryClass.getField("NOT_FOUND")
                    .getInt(null);
                wasInit = true;
            } catch (Exception e) {
