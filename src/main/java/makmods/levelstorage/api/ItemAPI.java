...
public class ItemAPI {
    ...
    public static ItemStack getItem(String name, int meta) {
        try {
            ...
            if (obj instanceof Item) return new ItemStack((Item) obj, 1, meta);
            if (obj instanceof Block) return new ItemStack((Block) obj, 1, meta);
            return null;
        } catch (Exception e) {
    ...
    public static class SimpleItemAPI {
        ...
        static {
            ...
            o_SimpleItemsInstance = APIHelper.getInstanceFor(SIMPLE_ITEMS_CLASSNAME);
        }
